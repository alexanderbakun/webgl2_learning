engine.input.keyboard = class keyboard {
  ...
  static getKeyNameFromEvent(e) {
    return (e.location !== 0 ? e.code : e.key);
  }
  ...
  static getKeyInfoFromKeyCode(code,cb) {
    var getter = document.createElement('div');
    getter.addEventListener('keydown',cb);
    getter.dispatchEvent(new Event('keydown'));
    return this;
  }
  
  static setKey(title,code) {
    this.keys[code] = title;
    return this;
  }
